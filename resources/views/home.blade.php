...
@pushOnce('scripts')
    ...
    <script src="{{ asset('dist/libs/jquery-raty-js/lib/jquery.raty.js') }}"></script>
@endPushOnce
        ...
        @if (session('status'))
            ...
            <div id="toast-container" class="toast-container toast-top-right">
                <div class="toast toast-success" aria-live="polite" style="display: block;">
                    ...
                    <div class="toast-title">With Close Button</div>
        ...
        <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">{{ __('Home') }}</h4>
        ...
        <div class="owl-carousel counter-carousel owl-theme">
                ...
                <div class="card border-0 zoom-in bg-light-primary shadow-none">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{ asset('dist/images/svgs/icon-user-male.svg') }}" width="50" height="50"
                                class="mb-3" alt="" />
            ...
            <div class="item">
                <div class="card border-0 zoom-in bg-light-warning shadow-none">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{ asset('dist/images/svgs/icon-briefcase.svg') }}" width="50" height="50"
                                class="mb-3" alt="" />
            ...
            <div class="item">
                <div class="card border-0 zoom-in bg-light-info shadow-none">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{ asset('dist/images/svgs/icon-mailbox.svg') }}" width="50" height="50"
                                class="mb-3" alt="" />
                            {{-- <p class="fw-semibold fs-3 text-info mb-1">{{ __('tasks') }}</p> --}}
                            {{-- <h5 class="fw-semibold text-info mb-0">{{ auth()->user()->tasks->count() }}</h5> --}}
                        </div>
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="card border-0 zoom-in bg-light-danger shadow-none">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{ asset('dist/images/svgs/icon-favorites.svg') }}" width="50" height="50"
                                class="mb-3" alt="" />
            ...
            <div class="item">
                <div class="card border-0 zoom-in bg-light-success shadow-none">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{ asset('dist/images/svgs/icon-speech-bubble.svg') }}" width="50" height="50"
                                class="mb-3" alt="" />
            ...
            <div class="item">
                <div class="card border-0 zoom-in bg-light-info shadow-none">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{ asset('dist/images/svgs/icon-connect.svg') }}" width="50" height="50"
                                class="mb-3" alt="" />
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-7 pb-2">
                            <div class="me-3 pe-1">
                                <img src="{{ asset('dist/images/profile/user-1.jpg') }}" class="shadow-warning rounded-2"
                ...
                <div class="card bg-primary border-0 w-100">
                    <div class="card-body pb-0">
                        ...
                        <div class="text-center mt-3">
                            <img src="{{ asset('dist/images/backgrounds/piggy.png') }}" class="img-fluid"
                                alt="" />
                        </div>
                    </div>
