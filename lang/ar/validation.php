...
return [
    ...
    */
    ...
    'email' => 'يجب أن يكون يجب أن ينتهي حقل :attribute بواحد مما يلي: :values.',
    'enum' => 'الملف :attribute المحدد غير صالح.',
    'exists' => 'الملف :attribute المحدد غير صالح.',
    ...
    'lt' => [
        ...
        'file' => 'يجب أن يحتوي حقل :attribute على أقل من :value كيلوبايت.',
        'numeric' => 'يجب أن يحتوي حقل :attribute على أقل من :value.',
        'string' => 'يجب أن يحتوي حقل :attribute على أقل من :value أحرف.',
    ],
    'lte' => [
        'array' => 'يجب ألا يحتوي حقل :attribute على أكثر من :value عناصر.',
        'file' => 'يجب أن يحتوي حقل :attribute على أقل من أو يساوي :value كيلوبايت.',
        'numeric' => 'يجب أن يحتوي حقل :attribute على أقل من أو يساوي :value أحرف.',
    ],
    ...
    'max' => [
        ...
        'numeric' => 'يجب ألا يزيد حجم حقل :attribute عن :max.',
        'string' => 'يجب ألا يزيد حجم حقل :attribute عن :max أحرف.',
    ],
    'max_digits' => 'يجب ألا يزيد حجم حقل :attribute عن :max أرقام.',
    ...
    'password' => [
        ...
        'uncompromised' => 'ظهرت :attribute المحددة في تسرب بيانات. يُرجى اختيار :attribute مختلف.',
    ],
    ...
    'required_without_all' => 'يُطلب حقل :attribute عندما لا يكون أي من :values ​​موجودًا.',
